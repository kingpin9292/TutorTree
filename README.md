...
- **Typescript** is a typed superset of JavaScript that enhances the language by adding static type checking, interfaces, and improved tooling, allowing developers to catch errors early and write more predictable, maintainable code.

- **Next.js** Next.js is a powerful React framework that simplifies building modern web applications by providing built‑in routing, server‑side rendering, static site generation, API routes, and performance optimizations
